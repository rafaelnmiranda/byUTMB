...
export const EVENT_TYPE_STYLES: Record<EventType, EventTypeStyle> = {
  esporte: {
    ...
    chipActive: "bg-esporte text-white dark:bg-esporte-dark dark:text-utmb-blue",
  ...
  entretenimento: {
    ...
    chipActive: "bg-entretenimento text-white dark:bg-entretenimento-dark dark:text-utmb-blue",
  ...
  ativacao: {
    ...
    chipActive: "bg-ativacao text-white dark:bg-ativacao-dark dark:text-utmb-blue",
